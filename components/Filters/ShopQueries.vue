<template>
  ...
  const SlideBarFilter = resolveComponent("FiltersShopSimpleFilter");
  const SliderFilter = resolveComponent("FiltersShopSimpleFilter");
  const SimpleFilter = resolveComponent("FiltersShopSimpleFilter");
  </script>

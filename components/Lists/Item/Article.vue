    ...
    <NuxtLinkLocale
      :to="
        data.translations[0].Slug && data._state == 1
          ? `/library/publications/articles/${data.translations[0].Slug}`
          : null
      "
    ...
    >
      ...
      <div>
        ...
        <div class="flex flex-col gap-2 mt-3">
          ...
          <div class="text-gray-500" v-if="data.translations[0].Author">
            {{ $t("Authors") }}: <span>{{ data.translations[0].Author }}</span>
          </div>
